...
<center>
	<h1 style="margin-top: 70px">Product Report</h1>
<br>
...
<?php 
  $d="SELECT * FROM `tbl_book`INNER JOIN `tbl_subcategory` USING (`Subcat_Id`) INNER JOIN `tbl_category` USING (`Cat_Id`)";
  $res=select($d);
...
foreach ($res as $row) {
 ...
 ?>
    ...
    <tr>
          ...
          <td> <?php echo $row['Profit_Percentage'] ?></td>
...
<a style="margin-left: 1300px" href="product.php"><input type="button" class="btn btn-danger" value="Print"></a>
<br>
<br>
