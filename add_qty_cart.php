  ...
  else
{
  ...
  if (sizeof($qr)>0) {
      ...
      if (sizeof($qqs)>0) 
      {
          $qu="update tbl_childcart set quantity=quantity+'$qty' where mastcart_id='$cmmid' and Book_Id='$id'";
          update($qu);
          $qk="update tbl_mastcart set tot_amount=tot_amount+'$t_amount' where mastcart_id='$cmmid'";
          update($qk);
...
<!-- hero slider Start -->
    <div class="banner-wrap" style="height: 100px">
    ...
    <div class="row">
        <center><h1 align="center" style="margin: 1em;">Add to Cart</h1></center>
                ...
                <!-- <div class="col-lg-4 col-md-6 mt-lg-4 mt-4"> -->
                  <center>
                    <div class="grids5-info" >
                      <a href="#blog" class="blog-image d-block zoom">
    <img src="<?php echo $res[0]['Book_Img']?>" style="max-height: 300px; max-width: 250px;">
</a>
...
<center>
                            <h4><?php echo $res[0]['Subcat_Name']?> <br><?php echo $res[0]['Book_Title']?></h4>
        ...
        <div class="col-md-6 col-lg-8">
                      ...
                      <form method="post" >
                        ...
                        <div class="form-group col-md-6">
                          ...
                          <input type="submit" name="button"  class="btn btn-success" value="Add to Cart" >
                        </div>
                      </form>
                      </center>
</div>
