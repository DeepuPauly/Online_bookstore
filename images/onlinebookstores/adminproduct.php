<?php include 'connection.php';
  ...
  if(isset($_POST['submit'])) 
    ...
    move_uploaded_file($_FILES['imgg']['tmp_name'], $target1);
       ...
       $q="insert into `tbl_book` values(null,'$subcat_id','$title','$authorname','$publisher','$publication_date','$book_desc','$book_price','$book_date_added','1','0','$target1','0')";  
        insert($q);
...
<div class="boxinput">
    ...
    <input type="text" value="" name="authorname" placeholder="Book Author" id="authorname" required="" />
     ...
     <input type="text"  value="" name="book_date_added" placeholder="Book Date Added" maxlength="10" id="bookdate_added" required="" />
