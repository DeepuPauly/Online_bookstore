           ...
           <th>Action</th>
            ...
            <div class="staff-content-inner-top">
              ...
              <?php
                ...
                $query = "SELECT * FROM tbl_book"; // Replace with your actual query
              $app_num2 = $conn->query($query);
                ...
                if ($app_num2) {
                    while ($row_app = $app_num2->fetch_assoc()) {
                        ...
                        echo "<tr>";
                        echo "<td>" . $row_app['Book_Id'] . "</td>";
                        echo "<td>" . $row_app['Book_Title'] . "</td>";
                        ...
                        echo "<td>" . $row_app['Profit_Percentage'] . "</td>";
                        echo "<td>" . $row_app['Book_Description'] . "</td>";

                        
                        //edit staff button
                        echo '<td><form action="admin.php" method="POST"><input type="hidden" name="app_updateid" value="'. $row_app['Book_Id'] .'"><button type="submit" class="btn btn-primary me-md-2" name="update_app">UPDATE</button></form></td>';
                        echo "</tr>";
                    }
                } 
