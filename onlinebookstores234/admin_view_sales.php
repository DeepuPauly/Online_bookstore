 ...
 WHERE tbl_mastcart.cart_status !='Pending' ORDER BY added_date DESC";
                   ...
                   $myomif=$res1[0]['mastcart_id'];
                    ...
                    if($row['ostatus']=="Paid"){ ?>
                        ...
                        <strong><a class='btn btn-success' href="admin_assign_to_courire_service.php?cart_mid=<?php echo $row['mastcart_id']; ?>&Cust_Id=<?php echo $row['Cust_Id']; ?>&pay=<?php echo $row['Payment_Id'] ?>">Assign</a></strong>
                        </p>
