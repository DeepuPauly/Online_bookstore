...
<!--       <h1 class="logo me-auto me-lg-0"><a href="index.html">The Book Spot</a></h1>
 -->      <!-- Uncomment below if you prefer to use an image logo -->
    ...
    <h1 class="logo me-auto me-lg-0" style="margin-top: 10px;"><a href="index.html"><i><font size="5 px";>The Book Spot</a></h1></i>
    <!-- Uncomment below if you prefer to use an image logo -->
    <!-- <a href="index.html" class="logo me-auto me-lg-0"><img src="assets/img/logo.png" alt="" class="img-fluid"></a>-->
...
<!-- </form> -->
           ...
           <li><a class="fa fa-user-circle" style="font-size: 24px" href="login1.php"></a></li>
