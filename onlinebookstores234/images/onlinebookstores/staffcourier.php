  ...
  if(isset($_POST['submitss'])) 
    {
        ...
        if (sizeof($b) > 0) {
         ...
         $q="insert into tbl_login values('$username','$password','courier')";  
        insert($q);
        $q2="insert into tbl_courier values(null,'".$_SESSION['staff_id']."','$username','$password','$Cs_name','$Cs_Phone','$Cs_City','$Cs_Street','$Cs_Dist','$Cs_Pin','1')";
        insert($q2);
