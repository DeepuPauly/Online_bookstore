<?php include 'connection.php';
  ...
  if(isset($_POST['submit'])) 
    ...
    move_uploaded_file($_FILES['imgg']['tmp_name'], $target1);
      ...
      $q="insert into `tbl_book` values(null,'$cat_id','$subcat_id','$title','$authorname','$publisher','$publication_date','$book_desc','$book_price','$book_date_added','1','0','$target1')";  
        insert($q);
    }
        ?> 
...
<form   method="post" enctype= "multipart/form-data">
    ...
    <div>
        <select name="subcat_id">
            ...
            <?php 
           $css="select * from tbl_subcategory ";
            $d=select($css);
            ...
            foreach ($d as $i) {
             ...
             <option value="<?php echo $i ['Subcat_Id'] ?>"><?php echo $i['Subcat_Name'] ?></option>
    ...
    <input type="text" value="" name="authorname" placeholder="Book Author" id="authorname" required="" />
     ...
     <input type="text" maxlength=10 value="" name="publication_date" placeholder="Book Publication Date" id="publication_date" required="" />
     ...
     <input type="text" maxlength=10 value="" name="book_date_added" placeholder="Book Date Added" id="bookdate_added" required="" />
