...
<!--       <h1 class="logo me-auto me-lg-0"><a href="index.html">The Book Spot</a></h1>
 -->      <!-- Uncomment below if you prefer to use an image logo -->
    ...
    <h1 style="font-family: sans-serif;"><a href="index.html" class="sans-serif"><i><font size="5 px" color="white" ; style="margin-right: 1000px; "><img src="images/logo1.jpg" style="height: 70px">THE BOOK SPOT</a></h1></i>
    <!-- Uncomment below if you prefer to use an image logo -->
    <!-- <a href="index.html" class="logo me-auto me-lg-0"><img src="assets/img/logo.png" alt="" class="img-fluid"></a>-->
    <nav id="navbar" class="navbar order-last order-lg-0" style="margin-left:18em">
        <ul>
...
<!-- </form> -->
        ...
        <!--   &nbsp&nbsp&nbsp <li><a class="fa fa-user-circle" style="font-size: 24px" href="login1.php"></a></li -->
