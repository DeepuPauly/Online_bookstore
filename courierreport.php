...
<center>
	<h1 style="margin-top: 70px">Courier Report</h1>
<br>
...
<a style="margin-left: 1300px" href="courier.php"><input type="button" class="btn btn-danger" value="Print"></a>
<br>
<br>
