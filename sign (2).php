  ...
  if (isset($_POST['submitss'])) 
    {
        ...
        $q="insert into tbl_login values('$username','$password','customer','1')";  
        insert($q);

      $q2="insert into tbl_customer values(null,'$username','$fname','$lname','$address','$city','$district','$street','$pin','$phone','$dob','$gender','1')";
